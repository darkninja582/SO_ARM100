...
class ArmCommander(Node):
    def __init__(self):
        ...
        # Create the Publisher targeting your specific controller topic
    ...
    def move_to_coordinate(self, target_xyz):
        ...
        # 2. Setup IK Chain using the clean URDF, the new mask, AND the correct base
        my_arm_chain = ikpy.chain.Chain.from_urdf_file(
            ...
            base_elements=["root"]  # The crucial fix!
        )

        # 3. Calculate Inverse Kinematics (Pure math, no experimental hints/limits)
